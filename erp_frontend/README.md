...
# 💻📱 Sistema de Gestão Empresarial (ERP) Front-End

## ⛏️ Instalação

## Linux/Windows

Depois de clonar o repositorio, instale as bibliotecas

```bash
  npm i
```

Se o NPM não estiver instalado no seu SO, instale o NodeJs junto com NPM. O Linux já vem com o npm pré instalado

Após a instalação das bibliotecas, vamos instalar mais 3 adicionais
